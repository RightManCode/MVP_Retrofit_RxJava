...
public class HttpDownManager {
     ...
     * 
     * @author Lester Huang
     * @created 2017 /02/23 15:23:26 Start down.
     * @param info
     *            the info
     */
    public void startDown(final DownInfo info) {
        ...
        if (downInfos.contains(info)) {
            ...
            Retrofit retrofit = new Retrofit.Builder().client(builder.build())
                    ...
                    .addCallAdapterFactory(RxJavaCallAdapterFactory.create()).baseUrl(getBasUrl(info.getUrl())).build();
     ...
     * 
     * @author Lester Huang
     * @created 2017 /02/23 15:23:26 Stop down.
     * @param info
     *            the info
     */
     ...
     * 
     * @author Lester Huang
     * @created 2017 /02/23 15:23:26 Pause.
     * @param info
     *            the info
     */
     ...
     * 
     * @author Lester Huang
     * @created 2017 /02/23 15:23:26 Stop all down.
     */
     ...
     * 
     * @author Lester Huang
     * @created 2017 /02/23 15:23:26 Pause all.
     */
     ...
     * 
     * @author Lester Huang
     * @created 2017 /02/23 15:23:26 Remove.
     * @param info
     *            the info
     */
