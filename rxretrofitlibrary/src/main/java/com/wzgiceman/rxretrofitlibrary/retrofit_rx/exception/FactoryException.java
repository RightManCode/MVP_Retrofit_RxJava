...
/**
 * 异常处理工厂 主要是解析异常，输出自定义ApiException Created by WZG on 2016/12/12.
 *
 * @author Lester Huang
 * @created 2017 /02/23 15:24:23
 */
public class FactoryException {
    /**
     * The constant HttpException_MSG.
     */
    private static final String HttpException_MSG = "网络错误";
    /**
     * The constant ConnectException_MSG.
     */
    private static final String ConnectException_MSG = "连接失败";
    /**
     * The constant JSONException_MSG.
     */
    private static final String JSONException_MSG = "fastjeson解析失败";
    /**
     * The constant UnknownHostException_MSG.
     */
