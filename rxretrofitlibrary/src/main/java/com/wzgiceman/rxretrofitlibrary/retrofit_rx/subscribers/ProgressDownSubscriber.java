...
/**
 * 断点下载处理类Subscriber 用于在Http请求开始时，自动显示一个ProgressDialog
 * 在Http请求结束是，关闭ProgressDialog 调用者自己对请求数据进行处理 Created by WZG on 2016/7/16.
 *
 * @author Lester Huang
 * @created 2017 /02/23 15:43:25
 * @param <T>
 *            the type parameter
 */
public class ProgressDownSubscriber<T> extends Subscriber<T> implements DownloadProgressListener {
     ...
     * 
     * @author Lester Huang
     * @created 2017 /02/23 15:43:34 On start.
     */
    @Override
    public void onStart() {
     ...
     * 
     * @author Lester Huang
     * @created 2017 /02/23 15:43:34 On completed.
     */
    @Override
     ...
     *
     * @author Lester Huang
     * @created 2017 /02/23 15:43:34 On error.
     * @param e
     *            the e
     */
    @Override
     ...
     *
     * @author Lester Huang
     * @created 2017 /02/23 15:43:34 On next.
     * @param t
     *            创建Subscriber时的泛型类型
     */
    @Override
     ...
     * 
     * @author Lester Huang
     * @created 2017 /02/23 15:43:34 Update.
     * @param read
     *            the read
     * @param count
     *            the count
            ...
            rx.Observable.just(read).observeOn(AndroidSchedulers.mainThread())
                    .subscribe(new Action1<Long>() {
                      ...
                      /*如果暂停或者停止状态延迟，不需要继续发送回调，影响显示*/
                            if(downInfo.getState(DownState.START)==DownState.PAUSE||downInfo.getState(DownState.START)==DownState.STOP)return;
