...
/**
 * http交互处理类 Created by WZG on 2016/7/16.
 * 
 * @author Lester Huang
 * @created 2017 /02/23 15:25:05
 */
public class HttpManager {
    /**
     * The On next listener.
     */
    /* 软引用對象 */
    private SoftReference<HttpOnNextListener> onNextListener;
    /**
     * The App compat activity.
     */
     ...
     *
     * @author Lester Huang
     * @created 2017 /02/23 15:25:05 Do http deal.
     * @param basePar
     *            封装的请求数据
     */
    public void doHttpDeal(BaseApi basePar) {
        ...
        Retrofit retrofit = new Retrofit.Builder().client(builder.build())
                ...
                .addCallAdapterFactory(RxJavaCallAdapterFactory.create()).baseUrl(basePar.getBaseUrl()).build();
        /* rx处理 */
